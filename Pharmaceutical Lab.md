...
First up, let's look at what we can produce. For making money, we'll look at the highest Credits per kilogram. For supporting gameplay we'll add some interesting chems like Snake Oil and Repairing Immobilizer which will cover the bases in terms of curing afflictions.
...
From this list we'll focus on Analgesic Poultice, Repairing Immobiliser and Snake Oil. These items cover all the ailments we're likely to encounter, and poultices have the highest value per mass which makes them good for generating income.
...
My plan: produce Antimicrobial on Proycon III (already have an outpost for copper and coolant), deliver those to Serpentis IV and produce Analgesic Poultice on Serpentis IV.

To produce one load of 750 Analgesic Poultice requires (item weight, approximate storage requirements in brackets):
...
This plan requires producing a tad over 5 membrane per minute. My current Animal Husbandry Facility produces 2 membrane per minute so I'll need 3 AHF producing membrane. I usually build 2 industrial facilities for simplicity since membrane will be in high demand at this outpost.

This plan starts with establishing the minimal infrastructure required to get production going. Ramping up to industrial production will come later.

#### Repairing Immobilizer

- Bandages (see [Analgesic Poultice](#analgesic-poultice))
  - Fiber
    - Serpentis IV: Swamp Bottle Root (flora)
  - Sealant
    - Serpentis IV: Grabber (fauna)
- Biosuppressant
  - Alpha Andraste III: Lattice Leaf (flora)
- Immobilizer
  - Sealant
    - Serpentis IV: Grabber (fauna)
  - Structural Material
    - Serpentis IV: Stinkroot (flora)

The plan is to produce biosuppressant on Alpha Andraste III and import that to Serpentis IV where the rest of the ingredients are produced.
...
- Chlorine
  - Serpentis IV
- Metabolic Agent
  - Alpha Tirna VIII-c: Spaceroach (fauna)
  - Zeta Ophiuchi I: Tropical Maw Palm (flora), Eggsac (fauna)
  - Serpentis IV: Bugleweed (flora)
- Sedative
  - Procyon III: Octomaggot (fauna)
  - Alpha Andraste III: Twintail (fauna)
  - Schrodinger III: Loxodont (fauna)
...
- [Aurora](https://inara.cz/starfield/item/424/)
  - 1 Benzene
  - 1 Chasmbass Oil
  - 2 Hallucinogen
    - Alpha Andraste III: Abyss Pine Seedling or Sweet Root
  - 1 Stimulant
    - Procyon III: Coralcrab (collected, not produced)

These are presentd for informational purposes. I usually have no need for Aurora after getting far enough through the main quest line since we have better options.
...
Here are some food & drink recipes that can be crafted entirely from resources that are produced through outposts. Those labelled "(sans-aromatic)" are recipes that do not require the aromatic resource - these will be useful if you don't have a spare outpost to dedicate to producing aromatics.

Food:

- [Alien Jerky](https://inara.cz/starfield/item/29/) (sans-aromatic) 
- [Alien Kebabs](https://inara.cz/starfield/item/1149/) +75 Energy Resistance for 480s
- [Alien Stew](https://inara.cz/starfield/item/1151/) 150 damage resistance for 18 minutes
- [Creature Jam](https://inara.cz/starfield/item/1161/) +100 Energy Resistance for 480s

Drink:

- [Alien Broth](https://inara.cz/starfield/item/1147/) (sans-aromatic) +10 O2 for 300s
- [Alien Energy Drink](https://inara.cz/starfield/item/1148/) (sans-aromatic) +15% Movement Speed for 180s, +10% O2 Recovery for 180s, +10% CO2 Recovery Rate for 180s
- [Alien Liquor](https://inara.cz/starfield/item/1050/) (sans-aromatic) +10 Carry Capacity for 300s, 25% O2 Recovery for 300s, 25% CO2 Recovery Rate for 300s
- [Alien Tea](https://inara.cz/starfield/item/1053/) (sans-aromatic) +2% XP Gain for 900s
- [Alien Tonic](https://inara.cz/starfield/item/1054/) +10% O2 Recovery for 180s, +10% CO2 Recovery Rate for 180s
- [Boba Alien Tea](https://inara.cz/starfield/item/1049/) +10 O2 for 300s, +2% XP Gain for 900s
- [Distilled Water](https://inara.cz/starfield/item/1047/) (sans-aromatic) actions use 0.2% O2 for 180s
- [Lumberjack Julep](https://inara.cz/starfield/item/1169/) 100 damage resistance for 300s, 20% O2 Recovery for 300s, 20% CO2 Recovery Rate for 300s
...
In general you need about 1 water extractor for each greenhouse and Animal Husbandry Facility (AHF). Each AHF in this installation requires fibre too. This means that for each animal husbandry facility there are 2 water extractors and 1 greenhouse producing fiber. Then you find that production rates never quite match up with consumption rates, but fine tuning is something that can happen later.
...
- 8 Animal Husbandry Facility (analgesic, 4 membrane, sealant, spice, toxin)
- 12 Greenhouse (9 fiber, metabolic agent, nutrient, structural)
- 15 Extractor - Liquid (water)
- Storage - Liquid - Large (water)
- 13 Storage - Solid - Large (analgesic, antimicrobial, aromatic, biosuppressant, fiber, 2 membrane, metabolic agent, nutrient, sealant, sedative, spice, toxin)
...
Setting up the sealant producing AHF first will allow gradual construction of the rest of the outpost with locally produced sealant: 2 water extractors, 1 fibre greenhouse, 1 sealant AHF, 2 storage - solid - large (fibre, sealant).
...
### Alpha Andraste III (biosuppressant, hallucinogen, Xe)

This base exists to extract two resources: Biosuppressant and Xenon. For the pharmaceuticals lab the only thing we care about is biosuppressant (repairing immobiliser) unless you're also planning to produce Aurora in which case collect hallucinogen too. Xenon is useful for Laser Turret Mk III, and outpost lighting. You can probably collect enough Xenon to last the entire game just manually collecting it from vents as you fully survey Alpha Andraste III.
...
- 1 Storage - Liquid - Large (water)
- 2 Greenhouse (biosuppressant, hallucinogen)
- 2 Storage - Solid - Large (biosuppressant, hallucinogen)
...
Either of these planets will do. You'll end up visiting Hyla II as part of the main storyline.

Design:

- 1 Landing Pad with Shipbuilder
- 1 Wind Turbine - Advanced (25 power)
- 1 Extractor - Vapor (water)
- 1 Storage - Liquid - Large (water)
...
- Extractor - Gas (alkanes)
- Storage - Gas - Large (alkanes)
- Solar Dome
...
- My preferred food
  - Alien Liquor (O2/CO2 recovery)
  - Alien Stew (damage resistance)
- Amp
- Analgesic Poultice
- Antibiotic Injector
...
You can easily automate this collection with cargo links. I prefer doing the rounds manually since it's all relatively low volume and I like the change in scenery from Serpentis IV.

## References & Further Reading

- MattGyver, [Starfield Outpost](https://www.mattgyver.com/starfield-outpost) which contains a decent rundown on what you need in a pharmaceutical lab, with lots of diagrams.
- Zikorik, [Starfield Unlimited Storage & Automated Resources Guide](https://www.youtube.com/watch?v=4PpCgF9RtY4) which showcases an "unlimited" storage system which makes emptying inventory into local storage easier. I use this for Serpentis IV for small scall crafting. If I'm missing a resource I'll go collect a heap and dump it in the local storage. This system is not useful for situations where you want to pick materials out of your storage later.

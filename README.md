...
- [Advanced Nuclear Reactor Assembly Line](Advanced%20Reactor%20Assembly%20Line.md): walks you through setting up an outpost network based on MattGyver's "Advanced Reactor Assembly Manual" plans including advice on optimising throughput for XP grinding based on resetting vendors every two days and attempting to sell all the Vytinium Fuel Rods produced
- [Pharmaceutical Lab](Pharmaceutical%20Lab.md): three extra planets, set up a pharmaceutical lab to produce various medical aids such as amp, analgesic poultice, injector, and immobiliser
